        ...
        <Row className="skill-content g-4 justify-content-center">
          <Col xs={12} sm={6} md={6} lg={4} xl={4}>
            <div className="card p-4 h-100">
              ...
              <div>
                ...
                <span className="badge-custom">Node.js</span>
                <span className="badge-custom">Express.js</span>
                <span className="badge-custom">RESTful APIs</span>
              </div>
            </div>
          </Col>
          <Col xs={12} sm={6} md={6} lg={4} xl={4}>
            <div className="card p-4 h-100">
              ...
              <div>
                <span className="badge-custom">HTML/CSS</span>
                ...
                <span className="badge-custom">SASS</span>
              </div>
            </div>
          </Col>
          <Col xs={12} sm={6} md={6} lg={4} xl={4}>
          ...
          <Col xs={12} sm={6} md={6} lg={4} xl={4}>
            <div className="card p-4 h-100">
              ...
              <div>
                <span className="badge-custom">MongoDB</span>
          ...
          <Col xs={12} sm={6} md={6} lg={4} xl={4}>
            <div className="card p-4 h-100">
              <div className="d-flex align-items-center mb-3">
                ...
                <h5 className="fw-semibold mb-0 text-white">AI & ML</h5>
              </div>
              <div>
                <span className="badge-custom">ChatGPT</span>
                <span className="badge-custom">Gemini</span>
                <span className="badge-custom">Deep seek</span>
                <span className="badge-custom">Copilot</span>
              </div>
            </div>
          </Col>
          <Col xs={12} sm={6} md={6} lg={4} xl={4}>
            <div className="card p-4 h-100">
              ...
              <div>
                ...
                <span className="badge-custom">Github</span>
